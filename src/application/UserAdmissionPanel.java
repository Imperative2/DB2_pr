...
public class UserAdmissionPanel extends JPanel {
    ...
    private JLabel labelBrowserForm, labelBrowserTeacher, labelBrowserECTS, labelBrowserWeek, labelBrowserDay, labelBrowserTime,labelBrowserRoom, labelFreeSpace;
    ...
    private void createGroupsView() {
        ...
        listCourses.addListSelectionListener(e -> {
            ...
            if(course!=null){
                ...
                if(groupsModel.size()>0) listGroups.setSelectedIndex(0);
            }
        });
